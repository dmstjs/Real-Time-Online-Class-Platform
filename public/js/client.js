...
// const surveyURL = 'https://www.questionpro.com/t/AUs7VZq00L'; // 은선 삭제
const surveyURL = './date.html'; // 은선 삭제
...
let swalBackground = '#c3d9cd'; // black - #16171b - transparent ...
let peerGeo;
let peerConnection;
...
function setTheme(theme) {
    ...
    switch (mirotalkTheme) {
        case 'dark':
            // dark theme
            swalBackground = 'radial-gradient(#c3d9cd, #c3d9cd)';
            document.documentElement.style.setProperty('--body-bg', 'radial-gradient(#c3d9cd, #c3d9cd)');
            document.documentElement.style.setProperty('--msger-bg', 'radial-gradient(#c3d9cd, #c3d9cd)');
            document.documentElement.style.setProperty('--msger-private-bg', 'radial-gradient(#c3d9cd, #c3d9cd)');
            document.documentElement.style.setProperty('--wb-bg', 'radial-gradient(#c3d9cd, #c3d9cd)');
